...
for (const cat of cats){
  ...
  const card = `
          <div class="col">
              <div class="card">
                  <img src="${cat.thumb}" class="card-img-top" alt="placeholder kitten" data-fullimg="${cat.img}"data-bs-toggle="modal" data-bs-target="#exampleModal">
                <div class="card-body">
...
for (const cardImage of cardImages){
  cardImage.addEventListener("click",modalWindow )
}

function modalWindow (){
  console.log(this.getAttribute("src"))
 const fullpicture = this.dataset.fullimg
 const modalBody = document.querySelector(".modal-body")
 modalBody.innerHTML = `<img src="${fullpicture}" alt="placeholder">`
